                                                                  ...
                                                                  TextButton(
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (deletingSpans
                                                                        ...
                                                                        debugPrint(
                                                                            "Spans $deletingSpans from example ${widget.passedExample.id}  successfully deleted.");
                                                                      }
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                ElevatedButton(
                                                    ...
                                                    onPressed: () async {
                                                      ShowClearValidatedSpanDialog(
                                                        context,
                                                        example,
                                                      );
                                                    },
                                                    child: const Text(
                                                      'CLEAR VALIDATED SPAN',
                                                      style: TextStyle(
                                                          fontWeight:
                                                              FontWeight.bold,
                                                          fontSize: 18),
