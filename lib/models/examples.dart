...
ExamplesResponse? examplesResponseFromJson(String str) =>
    ExamplesResponse.fromJson(json.decode(str));

String examplesResponseToJson(ExamplesResponse? data) =>
...
class ExamplesResponse {
  ...
  factory ExamplesResponse.fromJson(Map<String, dynamic> json) =>
      ExamplesResponse(
        count: json["count"],
        next: json["next"],
        ...
        results: json["results"] == null
            ? []
            : List<Example?>.from(
                json["results"]!.map((x) => Example.fromJson(x))),
      );
