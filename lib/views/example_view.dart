...
class _ExampleViewState extends State<ExampleView> {
  ...
  openBox(List<Example?>? examples) async {
    var boxExamples = await Hive.openBox("Examples").then((boxExamples) async {
      await boxExamples.putAll({'Examples': examples});
      print("Apro la box da example view ${boxExamples.get("Examples")}");

      Example? example = boxExamples.get("Examples")[10];
      print(example!.text);
    });
  }
